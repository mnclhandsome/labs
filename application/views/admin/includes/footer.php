    ...
    <script src="<?php echo base_url();?>assets/assets/tether/js/tether.min.js" ></script>
    ...
    <script src="<?php echo base_url();?>assets/assets/bootstrapValidator.min.js" ></script>
    ...
    <script src="<?php echo base_url();?>assets/assets/chart-js/home-data2.js" ></script>
    <script src="<?php echo base_url();?>assets/assets/sparkline/jquery.sparkline.js" ></script>
	<script src="<?php echo base_url();?>assets/assets/sparkline/sparkline-data.js" ></script>
