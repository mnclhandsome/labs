...

{
	function __construct() 
	{
		...
		$this->load->database("Medicine_model");
	}
	
	// public function get_all_medicine_list($pharmacyID){
 ...
 //        return $this->db->get()->result_array();	
	...
	public function get_all_medicine_lists($pharmacyID){
		$this->db->select('*')->from('medicine_list');		
		$this->db->where('medicine_list.pharmacy_id',$pharmacyID);
		$this->db->order_by('medicine_list.medicine_id',"DESC");
